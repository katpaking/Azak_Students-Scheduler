...
public class MainController {
    ...
    public String showBoardList(Model model, Authentication authentication, HttpServletRequest httpServletRequest) {
        ...
        List<FreeBoard> freeBoards = freeBoardService.getAllFreeBoards().stream()
                .filter(board -> board.getFb_schoolCode().equals(schoolCode))
                .collect(Collectors.toList());

        List<SuggestBoard> suggestBoards = suggestBoardService.getAllSuggestBoards().stream()
                .filter(board -> board.getSb_schoolCode().equals(schoolCode))
                .collect(Collectors.toList());
    ...
    public String showPersonalMain(Model model, Authentication authentication, Principal principal) {
        ...
        List<Personal> personals = personalService.getAllPersonalList(member.getId());
